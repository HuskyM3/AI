...
# Use the SMT solving functionality provided by z3

from z3 import And, Or, Not, Bool
from z3 import Solver, sat

def SMTTRUE(): return True
def SMTFALSE(): return False
...
def trueVariables(assignment,vars):
  return [ x for x in vars if assignment[Bool(x)] == True ]
